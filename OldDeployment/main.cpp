...
void SteamHandler::UpdateItem(WorkshopItemInfo& info, std::string changeLog)
{
	...
	if (mod_file.is_open()) {
		mod_file << "name = \"$STR_DF_NAME\";\n";
		mod_file << "picture = \"DabsFramework/gui/images/dabs_framework_logo.edds\";\n";
		mod_file << "logo = \"DabsFramework/gui/images/dabs_framework_logo.edds\";\n";
		mod_file << "logoSmall = \"DabsFramework/gui/images/dabs_framework_logo.edds\";\n";
		mod_file << "logoOver = \"DabsFramework/gui/images/dabs_framework_logo.edds\";\n";
		mod_file << "tooltip = \"$STR_DF_TOOLTIP\";\n";
		mod_file << "overview = \"$STR_DF_DESCRIPTION\";\n";
		mod_file << "action = \"https://dab.dev\";\n";
		mod_file << "author = \"$STR_DF_AUTHOR\";\n";
		mod_file << "authorID = \"76561198247958888\";\n";
		mod_file << "version = \"1.0\";\n";
		mod_file.close();
	}
	else {
...
int main(int argc, char** argv)
{
	...
	if (argc > 1) {
		...
		std::ifstream version_file("P:\\DabsFramework\\Workbench\\version");
