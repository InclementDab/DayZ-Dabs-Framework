		...
		class defs
		{
			class imageSets
			{
				files[]=
				{
					...
					"DabsFramework/gui/icons/sharp-light.imageset",
					"DabsFramework/gui/icons/sharp-regular.imageset",
					"DabsFramework/gui/icons/sharp-solid.imageset",
					"DabsFramework/gui/icons/sharp-thin.imageset",
					"DabsFramework/gui/icons/sharp-solid.imageset",
					"DabsFramework/gui/icons/sharp-thin.imageset"
				};
			};
